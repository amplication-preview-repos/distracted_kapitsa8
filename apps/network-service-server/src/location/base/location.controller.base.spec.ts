...
const CREATE_INPUT = {
  ...
  id: "exampleId",
  name: "exampleName",
  registeredEmail: "exampleRegisteredEmail",
  routerIp: "exampleRouterIp",
  ...
  test("POST /locations", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        statusSince: CREATE_RESULT.statusSince.toISOString(),
      ...
      .expect([
        {
          ...
          statusSince: FIND_MANY_RESULT[0].statusSince.toISOString(),
  ...
  test("GET /locations/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        statusSince: FIND_ONE_RESULT.statusSince.toISOString(),
