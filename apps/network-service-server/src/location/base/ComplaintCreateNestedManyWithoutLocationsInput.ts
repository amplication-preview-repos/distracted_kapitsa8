...
@InputType()
class ComplaintCreateNestedManyWithoutLocationsInput {
...
export { ComplaintCreateNestedManyWithoutLocationsInput as ComplaintCreateNestedManyWithoutLocationsInput };
